    ...
    <footer className="relative mt-24 border-t border-stone-200 dark:border-steel-800 bg-stone-50 dark:bg-steel-950">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid gap-12 md:grid-cols-4">
        <div className="space-y-5 md:col-span-1">
          ...
          <p className="text-sm text-stone-500 dark:text-steel-300 leading-relaxed max-w-xs">
            Herrería artesanal argentina. Cada pieza es única, hecha a mano para
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-stone-500 dark:text-steel-300">
            <li>
              <Link
                href="/"
                className="hover:text-copper-500 dark:hover:text-copper-400 transition-colors"
              >
                Inicio
              </Link>
            </li>
      ...
      <div className="border-t border-stone-200 dark:border-steel-800/60">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-stone-400 dark:text-steel-400">
          ...
          <p>Cuchillos artesanales en Argentina.</p>
        </div>
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pb-5 flex justify-center">
          <p className="text-[10px] text-stone-300 dark:text-steel-700 tracking-widest">
            made with{" "}
            <span
              className="text-stone-400 dark:text-steel-600"
              aria-label="amor"
            >
              ♥
            </span>{" "}
