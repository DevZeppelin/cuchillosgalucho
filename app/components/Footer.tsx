      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid gap-12 md:grid-cols-4">
        <div className="space-y-5 md:col-span-1">
          ...
          <p className="text-sm text-steel-300 leading-relaxed max-w-xs">
            Forja artesanal argentina. Cada pieza es única, hecha a mano para acompañar
            toda una vida.
          </p>
        </div>

        <div>
          <h3 className="font-display text-lg text-copper-300 mb-4">Navegación</h3>
          <ul className="space-y-2 text-sm text-steel-300">
            <li><Link href="/" className="hover:text-copper-400 transition-colors">Inicio</Link></li>
            <li><Link href="/#catalogo" className="hover:text-copper-400 transition-colors">Catálogo</Link></li>
            <li><Link href="/nosotros" className="hover:text-copper-400 transition-colors">Nosotros</Link></li>
            <li><Link href="/mayoristas" className="hover:text-copper-400 transition-colors">Mayoristas</Link></li>
          </ul>
        </div>

        <div>
          <h3 className="font-display text-lg text-copper-300 mb-4">Materiales</h3>
          <ul className="space-y-2 text-sm text-steel-300">
        ...
        <div>
          <h3 className="font-display text-lg text-copper-300 mb-4">Contacto</h3>
          <ul className="space-y-2 text-sm text-steel-300">
            <li>
              <a
            ...
            <li>
              <a
                ...
                className="hover:text-copper-400 transition-colors inline-flex items-center gap-2"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M17.6 6.32A8 8 0 005.93 17.5l-1.18 4.31 4.41-1.16a8 8 0 008.43-13.32z"/></svg>
                WhatsApp
              </a>
            </li>
