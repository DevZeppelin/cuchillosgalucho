    ...
    <section ref={sectionRef} className="relative py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8 relative">
        ...
        <div aria-hidden className="flex items-center justify-center gap-3 mb-16">
          ...
          />
          <div className="w-1 h-1 rounded-full bg-copper-500 opacity-50" />
            ...
            return (
              ...
              >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: "0 0 14px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.06)",
                      }}
                    >
                      <Icono />
                    </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs md:text-sm text-stone-500 dark:text-steel-300/65 leading-relaxed max-w-[165px]">
                    {m.descripcion}
                  </p>
                </div>
              </div>
